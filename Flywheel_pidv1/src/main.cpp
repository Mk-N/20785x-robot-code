...
void set_values(float f_TF_RPM, float f_FM1_Kp, float f_FM1_Ki, 
                float f_FM1_Kd, float f_FM2_Kp, float f_FM2_Ki,
                float f_FM2_Kd, int i_FM1_Integral_Limit, int i_FM2_Integral_Limit)
{
                Target_Flywheel_RPM = f_TF_RPM/6;
                Motor1_Kp = f_FM1_Kp;
                Motor1_Ki = f_FM1_Ki;
                Motor1_Kd = f_FM1_Kd;
                Motor2_Kp = f_FM2_Kp; 
...
{
  Motor1_Error = Target_Flywheel_RPM - f_left_velocity;
  Motor2_Error = Target_Flywheel_RPM - f_right_velocity;
}
...
int main() {
  ...
  vexcodeInit();
  wait(1,sec);
  // target flywheel RPM is between 0 and 3600
  set_values(Target_Flywheel_RPM, Motor1_Kp, Motor1_Ki, Motor1_Kd,
