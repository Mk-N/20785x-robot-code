...
void default_constants() {
  ...
  chassis.set_pid_constants(&chassis.headingPID, 4, 2, 2, 0);
  chassis.set_pid_constants(&chassis.forward_drivePID, 0.4, 0.05, 0.25, 0);
  chassis.set_pid_constants(&chassis.backward_drivePID, 0.4, 0.05, 0.25, 0);
